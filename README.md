...
_This article was originally posted on [my blog](http://hossaindoula.com/posts/2017/12/21/java-8-tutorial/)._

> [“Java is still not dead—and people are starting to figure that out.”](https://hossaindoula.com/blog/status/429603588525281280)
...
LocalDate represents a distinct date, e.g. 2017-03-11. It's immutable and works exactly analog to LocalTime. The sample demonstrates how to calculate new dates by adding or subtracting days, months or years. Keep in mind that each manipulation returns a new instance.
...
LocalDate xmas = LocalDate.parse("21.12.2017", germanFormatter);
System.out.println(xmas);   // 2017-12-21
```
...
LocalDateTime parsed = LocalDateTime.parse("Nov 03, 2017 - 07:13", formatter);
String string = formatter.format(parsed);
System.out.println(string);     // Nov 03, 2017 - 07:13
```
...
I've also published a bunch of follow-up articles on my [blog](http://hossaindoula.com) that might be interesting to you:

- [Java 8 Stream Tutorial](http://hossaindoula.com/posts/2017/12/21/java8-stream-tutorial-examples/)
- [Java 8 Nashorn Tutorial](http://hossaindoula.com/posts/2017/12/21/java8-nashorn-tutorial/)
- [Java 8 Concurrency Tutorial: Threads and Executors](http://hossaindoula.com/posts/2017/12/21/java8-concurrency-tutorial-thread-executor-examples/)
- [Java 8 Concurrency Tutorial: Synchronization and Locks](http://hossaindoula.com/posts/2017/12/21/java8-concurrency-tutorial-synchronized-locks-examples/)
- [Java 8 Concurrency Tutorial: Atomic Variables and ConcurrentMap](http://hossaindoula.com/posts/2017/12/21/java8-concurrency-tutorial-atomic-concurrent-map-examples/)
- [Java 8 API by Example: Strings, Numbers, Math and Files](http://hossaindoula.com/posts/2017/12/21/java8-examples-string-number-math-files/)
- [Avoid Null Checks in Java 8](http://hossaindoula.com/posts/2017/12/21/avoid-null-checks-in-java/)
- [Fixing Java 8 Stream Gotchas with IntelliJ IDEA](http://hossaindoula.com/posts/2017/12/21/fixing-java-8-stream-gotchas-with-intellij-idea/)
- [Using Backbone.js with Java 8 Nashorn](http://hossaindoula.com/posts/2017/12/21/using-backbonejs-with-nashorn/)

You should [follow me on Github](https://github.com/hossaindoula). Thanks for reading!
